...
var ReactTelephoneInput = exports.ReactTelephoneInput = React.createClass({
    ...
    // if the provided onlyCountries is an array of strings
    ...
    handleFlagItemClick: function handleFlagItemClick(country) {
        ...
        // country may be an array containing an iso2 and a keyboard event, or an object - turn into object in order to look up
        if (this.isOnlyCountriesNotSet()) {

          // no preferred countries
    ...
    handleKeydown: function handleKeydown(event) {
        ...
        switch (event.which) {
            ...
            case keys.UP:
                ...
                break;
            case keys.ENTER:
                this.handleFlagItemClick(this.state.preferredCountries.concat((this.isOnlyCountriesString()[this.state.highlightCountryIndex] ? this.getCountryObjectsFromStrings() : this.props.onlyCountries[this.state.highlightCountryIndex]), event));
                break;
            case keys.ESC:
